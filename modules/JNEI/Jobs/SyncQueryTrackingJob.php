...
namespace Modules\JNEI\Jobs;

use App\Base\Job;
use Gobiz\Workflow\WorkflowException;
use Modules\JNEI\Services\JNEIShippingPartner;
...
class SyncQueryTrackingJob extends Job
{
    ...
    public function handle()
    {
        ...
        $jnei      = new JNEIShippingPartner($this->shippingPartner->settings, config('services.jnei.api_url'));
        $trackings = $jnei->getTrackings($this->trackingNos);
