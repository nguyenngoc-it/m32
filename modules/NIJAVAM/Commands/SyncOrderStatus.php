...
namespace Modules\NIJAVAM\Commands;
...
class SyncOrderStatus
{
    ...
    {
        $this->logger = LogService::logger('nijavam-hook');
        ...
        if (!$orderStatus = Service::NIJAVAM()->mapStatus($status)) {
        ...
        try {
            ...
            throw new ShippingPartnerException("NIJAVAM.WEBHOOK.CHANGE_STATUS_FAILED: " . json_encode($errorPayload));
        }
    }
    ...
    {
        return Order::query()->where('shipping_partner_code', ShippingPartner::PARTNER_NIJAVAM)
