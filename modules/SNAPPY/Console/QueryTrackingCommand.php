...
use Modules\SNAPPY\Jobs\SyncQueryTrackingJob;

class QueryTrackingCommand extends Command
{
    protected $signature = 'snappy:query-trackings';

    protected $description = 'Lấy danh sách đơn hàng của SNAPPY để cập nhật thông tin trạng thái';

    public function handle()
    {
        $shippingPartners = ShippingPartner::query()->where('partner_code', ShippingPartner::CARRIER_SNAPPY)->get();
