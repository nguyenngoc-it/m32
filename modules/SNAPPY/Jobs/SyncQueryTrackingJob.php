...
class SyncQueryTrackingJob extends Job
{
    ...
    public function handle()
    {
        ...
        $snappy    = new SNAPPYShippingPartner($this->shippingPartner->settings, config('services.snappy.api_url'));
        $trackings = $snappy->getTrackings($this->trackingNos);
