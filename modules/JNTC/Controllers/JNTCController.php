...
namespace Modules\JNTC\Controllers;

use App\Base\Controller;
use Gobiz\Log\LogService;
use Modules\JNTC\Jobs\SyncOrderStatusJob;

class JNTCController extends Controller
{
    /**
    ...
    public function webhook()
    {
        ...
        LogService::logger('jntc-hook')->debug('WEBHOOK', $inputs);
