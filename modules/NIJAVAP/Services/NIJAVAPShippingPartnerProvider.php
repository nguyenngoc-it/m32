...
class NIJAVAPShippingPartnerProvider extends ShippingPartnerProvider
{
    /**
    ...
    {
        return ShippingPartner::$nameShippingProviders[ShippingPartner::PARTNER_NIJAVAP];
    }
    ...
    {
        return ShippingPartner::PARTNER_NIJAVAP;
    }
    ...
    {
        return new NIJAVAPShippingPartner($partner->settings, config('services.nijavap.api_url'));
    }
}
