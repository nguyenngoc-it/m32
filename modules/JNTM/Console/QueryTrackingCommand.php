...
namespace Modules\JNTM\Console;

use Carbon\Carbon;
use Illuminate\Console\Command;
use Modules\JNTM\Jobs\SyncQueryTrackingJob;
use Modules\Order\Models\Order;
use Modules\ShippingPartner\Models\ShippingPartner;

class QueryTrackingCommand extends Command
{
    protected $signature = 'jntm:query-trackings';

    protected $description = 'Lấy danh sách đơn hàng của JNTM để cập nhật thông tin trạng thái';

    public function handle()
    {
        $shippingPartners = ShippingPartner::query()->where('partner_code', ShippingPartner::CARRIER_JNTM)->get();
