...
{
    protected $signature = 'jntm:pull-locations';

    protected $description = 'Pull locations for JNTM Malaysia';
    ...
    public function handle()
    {
        ...
        foreach ($provinceLocations as $provinceLocation) {
            ShippingPartnerLocation::firstOrCreate(
                [
                    'partner_code'  => ShippingPartner::PARTNER_JNTM,
                    'type'          => Location       ::TYPE_PROVINCE,
                    'location_code' => $provinceLocation->code
                ],
                [
                    'parent_location_code' => 'malaysia',
