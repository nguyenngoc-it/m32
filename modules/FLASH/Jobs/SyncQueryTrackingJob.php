...
class SyncQueryTrackingJob extends Job
{
    ...
    public function handle()
    {
        ...
        $flash     = new FLASHShippingPartner($this->shippingPartner->settings, config('services.flash.api_url'));
        $trackings = $flash->getTrackings($this->trackingNos);
