...
namespace Modules\JNTT\Jobs;

use App\Base\Job;
use Gobiz\Workflow\WorkflowException;
use Modules\JNTT\Services\JNTTShippingPartner;
...
class SyncQueryTrackingJob extends Job
{
    ...
    public function handle()
    {
        ...
        $jntt      = new JNTTShippingPartner($this->shippingPartner->settings, config('services.jntt.api_url'));
        $trackings = $jntt->getTrackings($this->trackingNos);
